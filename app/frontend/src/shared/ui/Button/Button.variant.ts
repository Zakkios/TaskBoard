export const variantClasses: Record<string, string> = {
  ...
  white:
    "bg-white cursor-pointer hover:scale-105 hover:shadow-lg shadow-md border-1 border-[#DEDEDE] flex items-center gap-2 py-2 px-5 mr-8 rounded-xl font-semibold transition-all duration-200",
  "nav-item-active":
